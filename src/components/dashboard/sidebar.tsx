...
const adminNav: NavItem[] = [
  {
    label: '대시보드',
    href: '/admin',
    icon: <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" d="M3.75 6A2.25 2.25 0 0 1 6 3.75h2.25A2.25 2.25 0 0 1 10.5 6v2.25a2.25 2.25 0 0 1-2.25 2.25H6a2.25 2.25 0 0 1-2.25-2.25V6Z" /></svg>,
  },
  {
    label: '테넌트 관리',
    href: '/admin/tenants',
    ...
    <aside className="flex w-64 shrink-0 flex-col border-r border-slate-200 bg-white">
      <div className="border-b border-slate-200 px-4 py-4">
        <Link href="/" className="text-lg font-bold text-slate-900">
          ProSite <span className="text-xs font-normal text-slate-400">Admin</span>
        </Link>
      </div>
...
export function TenantSidebar() {
  return (
    <aside className="flex w-64 shrink-0 flex-col border-r border-slate-200 bg-white">
      <div className="border-b border-slate-200 px-4 py-4">
        <Link href="/" className="text-lg font-bold text-slate-900">
          ProSite <span className="text-xs font-normal text-slate-400">Dashboard</span>
        </Link>
      </div>
      <nav className="flex-1 space-y-1 p-4">
        {tenantNav.map((item) => (
